$(function () {
  ...
  function setup() {
    ...
    createCannon("left", 0, 300); // cannon on left wall, 600px down, shooting once per second
    createCannon("top", 0, 100); // cannon on top wall, 600px down, shooting once per second
