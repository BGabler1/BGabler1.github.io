$(function () {
  ...
  function setup() {
    ...
    createCollectable("rob", 500, 300); // creates a "rob" collectible at the coordinates (500, 300), falling with default gravity and bouncing with default bounce %
    ...
    createCannon("top", 800, 0); // cannon on top wall, 600px down, shooting once per second
    createCannon("right", 1000, 1000); // cannon on right wall, 600px down, shooting once per second
